...
import { useHourlySalesReport } from "../hooks/useHourlySalesReport";
import {
  exportHourlySalesReportPDF,
  exportHourlySalesReportExcel,
...
import { HourlySalesReportPrintPreviewModal } from "../components/HourlySalesReportPrintPreviewModal";

export const HourlySalesReportPage = () => {
  const navigate = useNavigate();
  const { filters, masterData, report } = useHourlySalesReport();
  ...
  // dynamic paymode column list (exclude Time)
  const dynamicPaymodes = useMemo(() => {
    return report.columns.filter((c) => c !== "Time");
  }, [report.columns]);
  ...
  return (
    <PageShell title="Hourly Sales Report">
      ...
      <HourlySalesReportPrintPreviewModal
...
export default HourlySalesReportPage;
