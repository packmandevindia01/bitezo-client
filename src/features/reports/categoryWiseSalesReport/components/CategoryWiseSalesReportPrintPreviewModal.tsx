...
interface CategoryWiseSalesReportPrintPreviewModalProps {
  isOpen: boolean;
  onClose: () => void;
  onExportPDF: () => void;
  data: {
...
export const CategoryWiseSalesReportPrintPreviewModal = ({
  isOpen,
  onClose,
  onExportPDF,
  data,
}: CategoryWiseSalesReportPrintPreviewModalProps) => {
        ...
        <div className="flex-1 overflow-auto bg-gray-100 rounded-lg p-2 flex justify-center border border-gray-200">
          ...
          >
            ...
            <div className="flex justify-between items-end mb-4 text-sm border-b pb-3 border-gray-200">
              ...
              <div>
                <p>
                  <span className="text-gray-500 w-20 inline-block font-medium">Category:</span>
                  <span className="font-semibold text-gray-800">{data.categoryName}</span>
                </p>
              </div>
            </div>
            ...
            <table className="w-full text-xs border-collapse print-table mb-6">
              <thead>
                <tr className="bg-gray-100 text-gray-800 font-bold border border-gray-300">
                  ...
                  <th className="py-2 px-2.5 text-center border border-gray-300 w-32">Category Code</th>
                  <th className="py-2 px-2.5 text-left border border-gray-300">Category Name</th>
