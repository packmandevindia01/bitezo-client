...
import { useCategoryWiseSalesReport } from "../hooks/useCategoryWiseSalesReport";
import {
...
import { CategoryWiseSalesReportPrintPreviewModal } from "../components/CategoryWiseSalesReportPrintPreviewModal";

export const CategoryWiseSalesReportPage = () => {
  const navigate = useNavigate();
  const { filters, masterData, report } = useCategoryWiseSalesReport();
  ...
  const selectedCategoryName = useMemo(() => {
    return (
      masterData.categoryOptions.find((c) => c.value === filters.categoryId)?.label || "All"
    );
  }, [filters.categoryId, masterData.categoryOptions]);
  ...
  const handleExportPDF = useCallback(() => {
    exportCategoryWiseSalesReportPDF(report.rows, report.totalData, {
      branchName: selectedBranchName,
      categoryName: selectedCategoryName,
      fromDate: filters.fromDate,
      toDate: filters.toDate,
    });
  }, [report, filters, selectedBranchName, selectedCategoryName]);

  const handleExportExcel = useCallback(() => {
    exportCategoryWiseSalesReportExcel(report.rows, report.totalData, {
      branchName: selectedBranchName,
      categoryName: selectedCategoryName,
      fromDate: filters.fromDate,
      toDate: filters.toDate,
  ...
  return (
    <PageShell title="Category Wise Sales Report">
            ...
            <div className="pb-3 xl:pb-0 xl:pr-4 flex flex-col sm:flex-row gap-4 shrink-0 justify-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-48">
                  <SearchableSelect
                    id="cwsr-category"
                    options={masterData.categoryOptions}
                ...
                {report.isLoading ? (
                  <tr>
                    <td colSpan={9} className="text-center py-12 text-gray-500">
                      Loading category wise sales data...
                    </td>
                  </tr>
      ...
      <CategoryWiseSalesReportPrintPreviewModal
...
export default CategoryWiseSalesReportPage;
