      ...
      <div className="rounded-3xl border border-gray-200 bg-white shadow-sm flex flex-col" style={{ maxHeight: "calc(100vh - 120px)" }}>
        ...
        <div className="mt-2 rounded-2xl border border-gray-200 bg-gray-50/70 p-3">
          <div className="grid gap-x-3 gap-y-1 md:grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_auto]">
            ...
            <FormInput id="rav-page-invAmnt" label="Inv Amnt" value={form.invAmnt} onChange={(e) => setField("invAmnt", e.target.value)} onKeyDown={(e) => handleKeyDown(e, "rav-page-paid")} />
            <FormInput id="rav-page-paid" label="Paid" value={form.paid} onChange={(e) => setField("paid", e.target.value)} onKeyDown={(e) => handleKeyDown(e, "rav-page-balance")} />
            <FormInput id="rav-page-balance" label="Balance" value={form.balance} onChange={(e) => setField("balance", e.target.value)} onKeyDown={(e) => handleKeyDown(e, "rav-page-amount")} />
            <FormInput id="rav-page-amount" label="Amount" value={form.amount} onChange={(e) => setField("amount", e.target.value)} onKeyDown={(e) => handleKeyDown(e, "rav-page-add-btn")} />
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 border-t border-gray-200 bg-white px-4 py-3 md:px-6 rounded-b-3xl">
          ...
          <Button id="rav-page-save-btn" className="h-10 px-6">
            SAVE
          </Button>
        </div>
      </div>
