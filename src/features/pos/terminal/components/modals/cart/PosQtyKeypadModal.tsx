      ...
      <div className="bg-[#f8fafc] p-4 sm:p-5 space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3 pt-1">
          ...
          <button
            ...
            className="h-14 bg-[#ff9500] text-white font-black uppercase text-xs sm:text-sm tracking-widest rounded-xl sm:rounded-2xl shadow-[0_4px_15px_rgba(255,149,0,0.3)] hover:bg-[#e68600] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
